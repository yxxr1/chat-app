...
describe('ChatItem renders', () => {
  ...
  test('renders content', () => {
    ...
    expect(screen.getByTestId('chatItem-container')).toMatchSnapshot();
  });
  ...
  test('render isCurrent=false, theme light', () => {
    ...
    expect(screen.getByTestId('chatItem-container')).toHaveStyle({
  ...
  test('onClick', () => {
    ...
    fireEvent.click(screen.getByTestId('chatItem-container'));
    fireEvent.click(screen.getByTestId('chatItem-container'));
